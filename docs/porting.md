...
See the [CLI documentation](cli/01-install.md) for full details.
...
- [API reference](cli/04-tooling-commands.md#fdl-api-ref) (via `fdl api-ref`)
- [Graph builder tutorial](tutorials/05-graph-builder.md)
- [Training tutorial](tutorials/04-training.md)
- [CLI documentation](cli/01-install.md) (project setup, libtorch management)

<!-- nav: generated by site/build_guide.py — do not edit below -->

---

Next: [Rust for PyTorch Users](tutorials/00-rust-primer.md)
