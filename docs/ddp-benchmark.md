...
> in delivered throughput on the big models). No GPU accumulated a
> reportable idle gap anywhere in the sweep - the streaming data plane
> and the async writeback path keep every card fed through the reduce
> windows (earlier sweeps showed fast-GPU idle in the sync rows; that
> era is documented in the git history of this file).
>
...
|------|------|------|--------|-----------|-------|--------------|------|------|------|----------|
| cpu-async | 1.031697 | 1.6319 | +0.1319 | 37.4 | 43 | 188.0 | ~54% | ~65% | ~56% | 0.0 |
| cpu-async-diloco | 0.970993 | 1.7300 | +0.2300 | 37.6 | 44 | 191.7 | ~57% | ~64% | ~55% | 0.0 |
| cpu-cadence | 1.008083 | 1.6523 | +0.1523 | 32.4 | 50 | 100.7 | ~71% | ~54% | ~44% | 0.0 |
| cpu-sync | 1.087977 | 1.5604 | +0.0604 | 150.4 | 283 | 179.0 | ~7% | ~41% | ~50% | 0.0 |
| nccl-cadence | 1.007039 | 1.6492 | +0.1492 | 29.4 | 51 | 0.1 | ~84% | ~65% | ~48% | 0.0 |
| nccl-sync | 1.085389 | 1.5604 | +0.0604 | 126.6 | 465 | 0.0 | ~25% | ~56% | ~60% | 0.0 |
...
|------|------|------|-----------|-------|--------------|------|------|------|----------|
| cpu-async | 0.001069 | 0.0009 | 5.3 | 10 | 41.1 | ~26% | ~22% | ~22% | 0.0 |
| cpu-async-diloco | 0.001195 | 0.0010 | 5.3 | 10 | 41.5 | ~19% | ~20% | ~21% | 0.0 |
| cpu-cadence | 0.001065 | 0.0010 | 6.3 | 23 | 41.4 | ~8% | ~14% | ~15% | 0.0 |
| cpu-sync | 0.000840 | 0.0008 | 7.3 | 19 | 45.2 | ~4% | ~14% | ~18% | 0.0 |
| nccl-cadence | 0.001064 | 0.0010 | 6.6 | 19 | 0.1 | ~13% | ~20% | ~21% | 0.0 |
| nccl-sync | 0.000794 | 0.0007 | 7.5 | 58 | 0.0 | ~8% | ~17% | ~22% | 0.0 |
...
| Mode | Loss | Eval | Total (s) | Syncs | Avg Sync (ms) | exa-cuda:GPU0 | flodl-pascal:GPU0 | flodl-pascal:GPU1 | Idle (s) |
|------|------|------|-----------|-------|--------------|------|------|------|----------|
| cpu-async | 1.830534 | 1.8897 | 48.6 | 44 | 169.7 | ~77% | ~95% | ~95% | 0.0 |
| cpu-async-diloco | 1.668466 | 1.7773 | 48.6 | 44 | 168.6 | ~76% | ~89% | ~92% | 0.0 |
| cpu-cadence | 1.791308 | 1.8632 | 49.6 | 51 | 91.8 | ~78% | ~84% | ~82% | 0.0 |
| cpu-sync | 1.936028 | 1.9643 | 141.4 | 539 | 157.5 | ~12% | ~62% | ~66% | 0.0 |
| nccl-cadence | 1.789453 | 1.8625 | 45.6 | 52 | 0.1 | ~89% | ~93% | ~92% | 0.0 |
| nccl-sync | 1.908234 | 1.9445 | 98.6 | 817 | 0.0 | ~43% | ~93% | ~96% | 0.0 |
...
| Mode | Loss | Eval | vs Ref | Total (s) | Syncs | Avg Sync (ms) | exa-cuda:GPU0 | flodl-pascal:GPU0 | flodl-pascal:GPU1 | Idle (s) |
|------|------|------|--------|-----------|-------|--------------|------|------|------|----------|
| cpu-async | 0.047672 | 0.9871 | -0.0029 | 5.3 | 10 | 41.5 | ~19% | ~24% | ~20% | 0.0 |
| cpu-async-diloco | 0.039942 | 0.9872 | -0.0028 | 6.3 | 10 | 41.9 | ~10% | ~20% | ~32% | 0.0 |
| cpu-cadence | 0.046433 | 0.9760 | -0.0140 | 5.3 | 10 | 41.8 | ~11% | ~22% | ~27% | 0.0 |
| cpu-sync | 0.039835 | 0.9887 | -0.0013 | 7.3 | 34 | 44.6 | ~8% | ~21% | ~26% | 0.0 |
| nccl-cadence | 0.045419 | 0.9891 | -0.0009 | 6.6 | 23 | 0.1 | ~18% | ~23% | ~28% | 0.0 |
| nccl-sync | 0.040401 | 0.9894 | -0.0006 | 7.6 | 66 | 0.1 | ~9% | ~27% | ~29% | 0.0 |
...
| Mode | Loss | Eval | vs Ref | Total (s) | Syncs | Avg Sync (ms) | exa-cuda:GPU0 | flodl-pascal:GPU0 | flodl-pascal:GPU1 | Idle (s) |
|------|------|------|--------|-----------|-------|--------------|------|------|------|----------|
| cpu-async | 0.306615 | 0.9209 | +0.0009 | 4.4 | 10 | 41.6 | ~6% | ~9% | ~11% | 0.0 |
| cpu-async-diloco | 0.287939 | 0.9230 | +0.0030 | 5.3 | 16 | 41.1 | ~5% | ~7% | ~13% | 0.0 |
| cpu-cadence | 0.311136 | 0.9178 | -0.0022 | 5.3 | 15 | 45.5 | ~8% | ~6% | ~8% | 0.0 |
| cpu-sync | 0.301714 | 0.9194 | -0.0006 | 5.6 | 17 | 45.6 | ~1% | ~5% | ~8% | 0.0 |
| nccl-cadence | 0.305632 | 0.9191 | -0.0009 | 5.6 | 19 | 0.1 | ~11% | ~12% | ~13% | 0.0 |
| nccl-sync | 0.297620 | 0.9197 | -0.0003 | 7.6 | 56 | 0.1 | ~0% | ~8% | ~10% | 0.0 |
...
| Mode | Loss | Eval | vs Ref | Total (s) | Syncs | Avg Sync (ms) | exa-cuda:GPU0 | flodl-pascal:GPU0 | flodl-pascal:GPU1 | Idle (s) |
|------|------|------|--------|-----------|-------|--------------|------|------|------|----------|
| cpu-async | 0.110886 | 0.9709 | -0.0041 | 4.4 | 10 | 43.8 | ~11% | ~17% | ~24% | 0.0 |
| cpu-async-diloco | 0.087361 | 0.9742 | -0.0008 | 5.1 | 10 | 43.7 | ~13% | ~17% | ~24% | 0.0 |
| cpu-cadence | 0.113265 | 0.9692 | -0.0058 | 5.6 | 19 | 43.1 | ~7% | ~10% | ~13% | 0.0 |
| cpu-sync | 0.099791 | 0.9703 | -0.0047 | 5.3 | 41 | 43.8 | ~10% | ~21% | ~25% | 0.0 |
| nccl-cadence | 0.110034 | 0.9696 | -0.0054 | 5.6 | 17 | 0.1 | ~17% | ~18% | ~26% | 0.0 |
| nccl-sync | 0.091849 | 0.9728 | -0.0022 | 6.6 | 59 | 0.1 | ~6% | ~17% | ~22% | 0.0 |
...
| Mode | Loss | Eval | vs Ref | Total (s) | Syncs | Avg Sync (ms) | exa-cuda:GPU0 | flodl-pascal:GPU0 | flodl-pascal:GPU1 | Idle (s) |
|------|------|------|--------|-----------|-------|--------------|------|------|------|----------|
| nccl-cadence | 0.039080 | 0.9208 | +0.0083 | 510.0 | 433 | 0.1 | ~86% | ~94% | ~92% | 0.0 |
...
| Mode | Loss | Eval | vs Ref | Total (s) | Syncs | Avg Sync (ms) | exa-cuda:GPU0 | flodl-pascal:GPU0 | flodl-pascal:GPU1 | Idle (s) |
|------|------|------|--------|-----------|-------|--------------|------|------|------|----------|
| cpu-async | 0.045352 | 0.9156 | +0.0031 | 497.9 | 215 | 69.8 | ~87% | ~96% | ~96% | 0.0 |
| cpu-async-diloco | 0.025878 | 0.9229 | +0.0104 | 499.7 | 223 | 70.8 | ~87% | ~96% | ~96% | 0.0 |
| cpu-cadence | 0.043084 | 0.9179 | +0.0054 | 503.0 | 270 | 52.1 | ~86% | ~92% | ~92% | 0.0 |
| cpu-sync | 0.036172 | 0.9159 | +0.0034 | 1607.3 | 15396 | 66.2 | ~14% | ~64% | ~67% | 0.0 |
| nccl-cadence | 0.038667 | 0.9178 | +0.0053 | 512.2 | 492 | 0.1 | ~87% | ~93% | ~93% | 0.0 |
| nccl-sync | 0.034333 | 0.9160 | +0.0035 | 1137.2 | 11048 | 0.0 | ~34% | ~93% | ~95% | 0.0 |
...
No non-solo run accumulated >=0.5s of classified idle on a dense-sampled device.
