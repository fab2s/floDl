---
permalink: /guide/0.8.x/architecture
channel: 0.8.x
sitemap: true
layout: guide
title: "Distributed Architecture"
prev_url: /guide/0.8.x/cli/source
prev_title: "Working in the Source Checkout"
next_url: /guide/0.8.x/windows-wsl
next_title: "Windows / WSL2"
anchors:
  - id: "1-role-topology"
    title: "1. Role topology"
  - id: "2-training-lifecycle"
    title: "2. Training lifecycle"
  - id: "3-coordinator-state-machine"
    title: "3. Coordinator state machine"
  - id: "4-reduce-backends"
    title: "4. Reduce backends"
  - id: "5-elche-scheduling-data-flow"
    title: "5. ElChe scheduling data flow"
  - id: "6-message-catalog"
    title: "6. Message catalog"
  - id: "7-failure-handling"
    title: "7. Failure handling"
last_modified_at: 2026-08-01T22:31:12+02:00
---
...
> [Multi-GPU Training](/guide/0.8.x/multi-gpu) for that, and the
> [DDP reference](/guide/0.8.x/ddp/reference) for the configuration surface. Names here are
...
[DDP reference](/guide/0.8.x/ddp/cluster-guide#dial-in-membership-the-join-window); this view is
