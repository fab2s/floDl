---
permalink: /guide/0.8.x/troubleshooting
channel: 0.8.x
sitemap: true
layout: guide
title: "Troubleshooting"
prev_url: /guide/0.8.x/mac-apple-silicon
prev_title: "Mac / Apple Silicon"
anchors:
  - id: "build-errors"
    title: "Build Errors"
  - id: "docker-errors"
  ...
  - id: "common-rust-compiler-messages"
    title: "Common Rust Compiler Messages"
  - id: "multi-gpu--ddp"
    title: "Multi-GPU / DDP"
  - id: "getting-help"
    title: "Getting Help"
last_modified_at: 2026-08-06T19:05:41+02:00
---
...
hangs), see the [DDP Reference - Troubleshooting](/guide/0.8.x/ddp/troubleshooting)
section.
...
- **Tutorials:** Start with [Rust for PyTorch Users](/guide/0.8.x/pytorch/rust-primer)
- **Multi-GPU:** [DDP Reference](/guide/0.8.x/ddp/reference) and [Multi-GPU Tutorial](/guide/0.8.x/multi-gpu)
- **Migration guide:** [PyTorch -> floDl](/guide/0.8.x/pytorch/migration)
