---
permalink: /guide/0.8.x/monitor
channel: 0.8.x
sitemap: true
layout: guide
title: "Training Monitor"
prev_url: /guide/0.8.x/utilities
prev_title: "Utilities"
next_url: /guide/0.8.x/graph-tree
...
anchors:
  ...
  - id: "export"
    title: "Export"
  - id: "hierarchical-models-graph-tree"
    title: "Hierarchical Models (Graph Tree)"
  - id: "monitor-vs-graph-observation"
    title: "Monitor vs. Graph Observation"
  - id: "complete-example"
    title: "Complete Example"
last_modified_at: 2026-08-02T16:36:47+02:00
---
...
> **Prerequisites**: [Training](/guide/0.8.x/training) covers the training loop.
> [Utilities](/guide/0.8.x/utilities) covers observation and trends.

> **Runnable examples**: [`quickstart`](https://github.com/flodl-labs/flodl/tree/main/flodl/examples/quickstart) trains with
> a live monitor; [`observation`](https://github.com/flodl-labs/flodl/tree/main/flodl/examples/observation) adds trend queries
> and early stopping.
...
[DDP guide → Sub-epoch reports](/guide/0.8.x/ddp/reference#sub-epoch-reports---reports_per_epoch).
...
When a graph has labeled children (see [Graph Tree](/guide/0.8.x/graph-tree)),
...
them independently. See [Independent flush cadences](/guide/0.8.x/graph-tree#independent-flush-cadences).
...
See [`flodl/examples/quickstart/`](https://github.com/flodl-labs/flodl/tree/main/flodl/examples/quickstart) for
