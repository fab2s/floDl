---
permalink: /guide/0.8.x/flodl-hf
channel: 0.8.x
sitemap: true
layout: guide
title: "HuggingFace Integration"
prev_url: /guide/0.8.x/data-loading
prev_title: "Data Loading"
next_url: /guide/0.8.x/ddp/reference
...
anchors:
  ...
  - id: "install"
    title: "Install"
  - id: "automodel-family-agnostic-loading"
    title: "AutoModel: family-agnostic loading"
  - id: "per-family-entry-points"
    title: "Per-family entry points"
  - id: "tokenizer"
    title: "Tokenizer"
  - id: "loading-from-local-disk"
    title: "Loading from local disk"
  - id: "fine-tune-save-export-verify"
    title: "Fine-tune, save, export, verify"
  - id: "round-trip-export"
    title: "Round-trip export"
  - id: "parity-with-pytorch"
    title: "Parity with PyTorch"
  - id: "checkpoints-with-only-pytorch_modelbin"
    title: "Checkpoints with only pytorch_model.bin"
  - id: "supported-families-and-roadmap"
    title: "Supported families and roadmap"
...
> **Prerequisites**: [Tensors](/guide/0.8.x/tensors),
> [Modules](/guide/0.8.x/modules), [Graph Builder](/guide/0.8.x/graph-builder), and
> (for the fine-tune walkthrough) [Training](/guide/0.8.x/training) and
> [Multi-GPU DDP](/guide/0.8.x/multi-gpu). Familiarity with HuggingFace
...
[Multi-GPU DDP](/guide/0.8.x/multi-gpu) for the multi-device story and
[`docs/design/trainer-execution-tiers.md`](https://github.com/flodl-labs/flodl/blob/main/docs/design/trainer-execution-tiers.md)
for the three tiers.
...
- [The floDl CLI](/guide/0.8.x/cli/install) (see `fdl add`, `fdl flodl-hf`, `fdl test-live`)
- [Multi-GPU DDP](/guide/0.8.x/multi-gpu) (the same `Trainer` entry point
