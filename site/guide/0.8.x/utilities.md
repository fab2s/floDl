---
permalink: /guide/0.8.x/utilities
channel: 0.8.x
sitemap: true
layout: guide
title: "Utilities"
prev_url: /guide/0.8.x/visualization
prev_title: "Visualization"
next_url: /guide/0.8.x/monitor
...
anchors:
  ...
  - id: "lr-scheduling"
    title: "LR Scheduling"
  - id: "trend-based-training-control"
    title: "Trend-based training control"
  - id: "verbosity-gated-logging"
    title: "Verbosity-gated logging"
  - id: "peak-vram-profiling"
    title: "Peak VRAM profiling"
  - id: "cuda-graphs"
    title: "CUDA Graphs"
...
peak-VRAM profiling, and CUDA Graphs. [Training](/guide/0.8.x/training) covers the
loop itself and points here for each of these.

> **Prerequisites**: [Training](/guide/0.8.x/training) introduces the
> backward/step loop. [The Graph Builder](/guide/0.8.x/graph-builder)
> introduces tags.

> **Runnable examples**:
> [`transfer_learning`](https://github.com/flodl-labs/flodl/tree/main/flodl/examples/transfer_learning) covers checkpoint
> save/partial load/freeze, [`schedulers`](https://github.com/flodl-labs/flodl/tree/main/flodl/examples/schedulers) composes
> warmup + cosine + plateau, and [`observation`](https://github.com/flodl-labs/flodl/tree/main/flodl/examples/observation)
...
[Training - Observing Training](/guide/0.8.x/training#observing-training)),
