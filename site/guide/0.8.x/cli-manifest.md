---
permalink: /guide/0.8.x/cli/manifest
channel: 0.8.x
sitemap: true
layout: guide
title: "The fdl.yml Manifest"
prev_url: /guide/0.8.x/cli/tooling
prev_title: "Introspection and Tooling"
next_url: /guide/0.8.x/cli/source
next_title: "Working in the Source Checkout"
anchors:
  - id: "the-general-principle"
    title: "The general principle"
  - id: "command-kinds-run--path--preset"
    title: "Command kinds: run / path / preset"
  - id: "declaring-flags-in-rust"
    title: "Declaring flags in Rust"
  - id: "environment-overlays"
    title: "Environment overlays"
  - id: "preset-sub-commands"
    title: "Preset sub-commands"
  - id: "fdl-config"
    title: "fdl config"
  - id: "fdl-schema-and---fdl-schema"
    title: "fdl schema and --fdl-schema"
  - id: "what-makes-a-cached-schema-stale"
    title: "What makes a cached schema stale"
last_modified_at: 2026-08-06T00:25:17+02:00
---
...
[DDP Reference: ElCheMode](/guide/0.8.x/ddp/reference#elchemode---cadence--backend-in-one-name)
