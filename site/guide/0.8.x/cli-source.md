---
permalink: /guide/0.8.x/cli/source
channel: 0.8.x
sitemap: true
layout: guide
title: "Working in the Source Checkout"
prev_url: /guide/0.8.x/cli/manifest
prev_title: "The fdl.yml Manifest"
next_url: /guide/0.8.x/architecture
next_title: "Distributed Architecture"
anchors:
  - id: "development-loop"
  ...
  - id: "benchmarks"
    title: "Benchmarks"
  - id: "ddp-validation-suite"
    title: "DDP validation suite"
  - id: "huggingface-flodl-hf"
    title: "HuggingFace (flodl-hf)"
  - id: "interactive-shells"
    title: "Interactive shells"
  - id: "re-building-the-cli"
    title: "Re-building the CLI"
...
See the
[HuggingFace Integration tutorial](/guide/0.8.x/flodl-hf) for
