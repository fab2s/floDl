---
permalink: /guide/0.8.x/training
channel: 0.8.x
sitemap: true
layout: guide
title: "Training"
prev_url: /guide/0.8.x/modules
prev_title: "Modules"
next_url: /guide/0.8.x/graph-builder
next_title: "The Graph Builder"
anchors:
  - id: "loss-functions"
  ...
  - id: "trainer-write-a-step-get-the-loop"
    title: "Trainer: write a step, get the loop"
  - id: "keep-your-own-loop"
    title: "Keep your own loop"
  - id: "the-training-loop"
    title: "The Training Loop"
  - id: "observing-training"
    title: "Observing Training"
  - id: "stateful-graphs---end_step"
    title: "Stateful Graphs - end_step"
  - id: "parameter-groups"
    title: "Parameter Groups"
  - id: "parameter-freezing"
    title: "Parameter Freezing"
  - id: "checkpoints"
    title: "Checkpoints"
  - id: "lr-scheduling"
    title: "LR Scheduling"
  ...
  - id: "eval-mode"
    title: "Eval Mode"
  - id: "training-housekeeping"
    title: "Training Housekeeping"
  - id: "reproducibility"
    title: "Reproducibility"
  - id: "complete-example"
    title: "Complete Example"
last_modified_at: 2026-08-01T14:51:07+02:00
---
...
[Modules](/guide/0.8.x/modules).

> **Runnable examples**: [`sine_wave`](https://github.com/flodl-labs/flodl/tree/main/flodl/examples/sine_wave) is the
> shortest end-to-end loop, [`quickstart`](https://github.com/flodl-labs/flodl/tree/main/flodl/examples/quickstart) adds a
> monitor, and [`mixed_precision`](https://github.com/flodl-labs/flodl/tree/main/flodl/examples/mixed_precision) shows
> `GradScaler` in place.
...
[Utilities - Gradient clipping](/guide/0.8.x/utilities#gradient-clipping) for when
...
`ClusterBuilder`), see [Multi-GPU Training](/guide/0.8.x/multi-gpu), the
[Heterogeneous & Multi-Host DDP tutorial](/guide/0.8.x/async-ddp), and the
[DDP Reference](/guide/0.8.x/ddp/reference).
...
Reference: `TrainerConfig<M>`](/guide/0.8.x/ddp/reference#trainerconfigm---the-umbrella).
...
- **You own the loop body, controller owns scheduling** (cooperative
  ...
  (see [trainer-execution-tiers](https://github.com/flodl-labs/flodl/blob/main/docs/design/trainer-execution-tiers.md)).
- **Explicit per-rank control** (bypass tier, multi-GPU):
  ...
  [Multi-GPU](/guide/0.8.x/multi-gpu)).
...
[HuggingFace Integration](/guide/0.8.x/flodl-hf) for a fine-tune walkthrough.
...
[Utilities - Checkpoints](/guide/0.8.x/utilities#checkpoints) covers the rest: the
...
[Utilities - LR Scheduling](/guide/0.8.x/utilities#lr-scheduling) has the full
...
[Utilities - Reproducibility](/guide/0.8.x/utilities#reproducibility) has the full
