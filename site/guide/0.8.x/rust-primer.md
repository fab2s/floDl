---
permalink: /guide/0.8.x/pytorch/rust-primer
channel: 0.8.x
sitemap: true
layout: guide
title: "Rust for PyTorch Users"
prev_url: /guide/0.8.x/pytorch/porting
prev_title: "Porting from PyTorch"
next_url: /guide/0.8.x/pytorch/migration
next_title: "PyTorch Migration Reference"
anchors:
  - id: "1-variables-let-and-let-mut"
    title: "1. Variables: let and let mut"
  - id: "2-references-x"
    title: "2. References: &x"
  - id: "3-the--operator-and-resultt"
    title: "3. The ? Operator and Result<T>"
  - id: "4-closures--"
    title: "4. Closures: || {}"
  - id: "5-vectors-slices-and-iteration"
    title: "5. Vectors, Slices, and Iteration"
  - id: "6-traits-like-abstract-classes"
    title: "6. Traits: Like Abstract Classes"
  - id: "7-types-youll-see-but-dont-need-to-understand"
    title: "7. Types You'll See But Don't Need to Understand"
  - id: "8-common-gotchas"
    title: "8. Common Gotchas"
  - id: "9-string-formatting"
    title: "9. String Formatting"
  - id: "10-the-full-picture-pytorch-vs-flodl-training-loop"
    title: "10. The Full Picture: PyTorch vs floDl Training Loop"
last_modified_at: 2026-07-30T23:28:37+02:00
---

# Rust for PyTorch Users
...
> [Porting Guide](/guide/0.8.x/pytorch/porting). For a side-by-side API reference, see the
> [PyTorch Migration Guide](/guide/0.8.x/pytorch/migration). You can also run
