---
permalink: /guide/0.8.x/async-ddp
channel: 0.8.x
sitemap: true
layout: guide
title: "Heterogeneous & Multi-Host DDP"
prev_url: /guide/0.8.x/multi-gpu
prev_title: "Multi-GPU Training"
next_url: /guide/0.8.x/data-loading
next_title: "Data Loading"
anchors:
  - id: "elche---the-cadence-balancer"
    title: "ElChe - the cadence balancer"
  - id: "convergence-guards---the-safety-belt"
    title: "Convergence guards - the safety belt"
  - id: "easgd-elastic-averaging-cpuasync"
    title: "EASGD elastic averaging (CpuAsync)"
  - id: "ab-testing-modes---the-recipe"
    title: "A/B testing modes - the recipe"
  - id: "heterogeneous-rig-real-world-example"
    title: "Heterogeneous-rig real-world example"
  - id: "cluster-topology---fdlclusteryml"
    title: "Cluster topology - fdl.cluster.yml"
  ...
  - id: "epochcallbackpolicyfastest---free-compute-callbacks"
    title: "EpochCallbackPolicy::Fastest - free-compute callbacks"
  - id: "quick-reference"
...
[Multi-GPU Training](/guide/0.8.x/multi-gpu) keeps working. This tutorial covers the
knobs that earn their keep on real heterogeneous deployments.

> **Prerequisites**: [Multi-GPU Training](/guide/0.8.x/multi-gpu). The
> universal `Trainer::builder` shape is assumed.

> **Time**: ~25 minutes.

> **Canonical reference**: [DDP Reference](/guide/0.8.x/ddp/reference).
...
[What "sync" means](/guide/0.8.x/ddp/reference#elchemode---cadence--backend-in-one-name)).
...
clusters](/guide/0.8.x/ddp/cluster-guide) for the full field listing.
