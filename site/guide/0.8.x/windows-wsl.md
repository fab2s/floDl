---
permalink: /guide/0.8.x/windows-wsl
channel: 0.8.x
sitemap: true
layout: guide
title: "Windows / WSL2"
prev_url: /guide/0.8.x/architecture
prev_title: "Distributed Architecture"
next_url: /guide/0.8.x/mac-apple-silicon
next_title: "Mac / Apple Silicon"
anchors:
  - id: "what-runs-where"
  ...
  - id: "setup"
    title: "Setup"
  - id: "two-settings-that-matter-for-flodl"
    title: "Two settings that matter for floDl"
  - id: "multi-gpu"
    title: "Multi-GPU"
  - id: "amd-gpus"
    title: "AMD GPUs"
...
last_modified_at: 2026-08-06T03:54:27+02:00
---
...
exact configuration (see [Benchmarks](/benchmark)):
...
See [Multi-GPU Training](/guide/0.8.x/multi-gpu) for the full picture.
