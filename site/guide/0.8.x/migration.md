---
permalink: /guide/0.8.x/pytorch/migration
channel: 0.8.x
sitemap: true
layout: guide
title: "PyTorch Migration Guide"
prev_url: /guide/0.8.x/pytorch/rust-primer
prev_title: "Rust for PyTorch Users"
next_url: /guide/0.8.x/tensors
next_title: "Tensors"
anchors:
  - id: "imports"
    title: "Imports"
  ...
  - id: "functional-ops-torchnnfunctional"
    title: "Functional Ops (torch.nn.functional)"
  - id: "activations-as-modules"
    title: "Activations (as Modules)"
  - id: "composite-modules"
  ...
  - id: "graph-builder-flodl-specific"
    title: "Graph Builder (flodl-specific)"
  - id: "graph-tree-hierarchical-composition"
    title: "Graph Tree (Hierarchical Composition)"
  - id: "training-monitor-replaces-tensorboard"
    title: "Training Monitor (replaces TensorBoard)"
  - id: "gpu-memory-queries"
    title: "GPU Memory Queries"
  - id: "multi-gpu-training-ddp"
    title: "Multi-GPU Training (DDP)"
...
> my_model.py` in Claude Code, or see the [Porting Guide](/guide/0.8.x/pytorch/porting).
...
See [Graph Tree tutorial](/guide/0.8.x/graph-tree) for the full API reference.
...
See the [DDP Reference](/guide/0.8.x/ddp/reference) for complete API documentation.
...
- [Porting Guide](/guide/0.8.x/pytorch/porting) - AI-assisted porting with `fdl` and the `/port` skill
- [CLI documentation](/guide/0.8.x/cli/install) - project scaffolding (`fdl init`), libtorch management, `fdl api-ref`
- [Graph builder tutorial](/guide/0.8.x/graph-builder) - FlowBuilder patterns in depth
- [DDP Reference](/guide/0.8.x/ddp/reference) - multi-GPU training
