---
permalink: /guide/0.8.x/tensors
channel: 0.8.x
sitemap: true
layout: guide
title: "Tensors"
prev_url: /guide/0.8.x/pytorch/migration
prev_title: "PyTorch Migration Reference"
next_url: /guide/0.8.x/autograd
next_title: "Autograd"
anchors:
  - id: "creating-tensors"
    title: "Creating Tensors"
  - id: "shape-inspection"
    title: "Shape Inspection"
  - id: "operations"
    title: "Operations"
  - id: "extracting-data"
  ...
  - id: "cudnn-benchmark-mode"
    title: "cuDNN Benchmark Mode"
  - id: "memory-format-channels-last"
    title: "Memory Format (Channels Last)"
  - id: "foreach-operations"
    title: "Foreach Operations"
...
> [Multi-GPU Training](/guide/0.8.x/multi-gpu) for the "no CUDA before
...
See [Training](/guide/0.8.x/training) for full reproducibility setup.
