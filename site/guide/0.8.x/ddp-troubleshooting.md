---
permalink: /guide/0.8.x/ddp/troubleshooting
channel: 0.8.x
sitemap: true
layout: guide
title: "DDP Troubleshooting"
prev_url: /guide/0.8.x/ddp/internals
prev_title: "Internals and Expert APIs"
next_url: /guide/0.8.x/cli/install
next_title: "Install and Global Flags"
...
guide](/guide/0.8.x/ddp/cluster-guide#dial-in-membership-the-join-window)).
