---
permalink: /guide/0.8.x/ddp/reference
channel: 0.8.x
sitemap: true
layout: guide
title: "Distributed Training Reference"
prev_url: /guide/0.8.x/flodl-hf
prev_title: "HuggingFace Integration"
next_url: /guide/0.8.x/ddp/cluster-guide
next_title: "Multi-Host Cluster Guide"
anchors:
  - id: "quick-start"
    title: "Quick start"
  - id: "elchemode---cadence--backend-in-one-name"
    title: "ElCheMode - cadence × backend in one name"
  - id: "trainerconfigm---the-umbrella"
    title: "TrainerConfig<M> - the umbrella"
  - id: "host-side-callbacks-metrics_fn--eval_fn"
    title: "Host-side callbacks: metrics_fn / eval_fn"
  - id: "slicing-a-pass-into-epochs---epoch_splits"
    title: "Slicing a pass into epochs - epoch_splits"
  - id: "sub-epoch-reports---reports_per_epoch"
    title: "Sub-epoch reports - reports_per_epoch"
  - id: "persisting-the-record-stream---record_log"
    title: "Persisting the record stream - record_log"
  - id: "saving-the-dashboard---save_dashboard"
    title: "Saving the dashboard - save_dashboard"
  - id: "declaring-how-a-scalar-rolls-up---scalar_reduction"
    title: "Declaring how a scalar rolls up - scalar_reduction"
  - id: "gpu-detection-without-a-gpu-runtime---flodlsysdetect_gpus"
    title: "GPU detection without a GPU runtime - flodl::sys::detect_gpus"
  - id: "auto-promote-single-host-n-gpus"
    title: "Auto-promote: single host, N GPUs"
  - id: "programmatic-clusters---clusterbuilder"
    title: "Programmatic clusters - ClusterBuilder"
  - id: "resume--checkpoints"
    title: "Resume + checkpoints"
  - id: "elastic-membership"
    title: "Elastic membership"
last_modified_at: 2026-08-09T19:21:41+02:00
---
...
[Multi-GPU Training](/guide/0.8.x/multi-gpu) and
[Heterogeneous & Multi-Host DDP](/guide/0.8.x/async-ddp).
...
[trainer execution tiers design note](https://github.com/flodl-labs/flodl/blob/main/docs/design/trainer-execution-tiers.md).)
...
| `ElCheConfig::cpu_async()` | `CpuAsync` (see [A/B testing modes](/guide/0.8.x/ddp/internals#ab-testing-modes)) |
...
| `.outer_optimizer(factory)` | `Fn() -> Box<dyn OuterOptimizer>` | Outer-loop optimizer on the consensus (SlowMo / DiLoCo). Default = plain work-weighted averaging (`OuterAvg`). See [Outer optimizer](/guide/0.8.x/ddp/internals#outer-optimizer---slowmo--diloco). |
...
[monitor tutorial → Querying the run by path](/guide/0.8.x/monitor#querying-the-run-by-path).
...
[monitor tutorial → One view, repeated per level](/guide/0.8.x/monitor#one-view-repeated-per-level).
...
misapplied. See [Phase lifecycle](/guide/0.8.x/ddp/internals#phase-lifecycle) for what
...
window (see [Dial-in membership](/guide/0.8.x/ddp/cluster-guide#dial-in-membership-the-join-window));
