---
permalink: /guide/0.8.x/graph-tree
channel: 0.8.x
sitemap: true
layout: guide
title: "Graph Tree"
prev_url: /guide/0.8.x/monitor
prev_title: "Training Monitor"
next_url: /guide/0.8.x/multi-gpu
next_title: "Multi-GPU Training"
anchors:
  - id: "labeling-subgraphs"
    title: "Labeling subgraphs"
  - id: "the-composed-flag"
    title: "The composed flag"
  - id: "label-path-addressing"
    title: "Label-path addressing"
  - id: "selective-freeze-and-thaw"
    title: "Selective freeze and thaw"
  - id: "parameter-groups-by-path"
    title: "Parameter groups by path"
  - id: "subgraph-checkpoint-loading"
    title: "Subgraph checkpoint loading"
  - id: "cross-boundary-observation"
    title: "Cross-boundary observation"
  - id: "internal-tags"
    title: "Internal tags"
  - id: "training-mode-propagation"
    title: "Training mode propagation"
  - id: "verbose-build-output"
  ...
  - id: "migrating-checkpoints-from-earlier-versions"
    title: "Migrating checkpoints from earlier versions"
  - id: "whats-next"
    title: "What's next"
...
> **Prerequisites**: [The Graph Builder](/guide/0.8.x/graph-builder) and
> [Advanced Graphs](/guide/0.8.x/advanced-graphs). You should be comfortable with
