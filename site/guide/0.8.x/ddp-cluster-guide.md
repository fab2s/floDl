---
permalink: /guide/0.8.x/ddp/cluster-guide
channel: 0.8.x
sitemap: true
layout: guide
title: "Multi-Host Cluster Guide"
prev_url: /guide/0.8.x/ddp/reference
prev_title: "Configuration Reference"
next_url: /guide/0.8.x/ddp/internals
next_title: "Internals and Expert APIs"
anchors:
  - id: "fdlclusteryml-schema"
    title: "fdl.cluster.yml schema"
  - id: "dial-in-membership-the-join-window"
    title: "Dial-in membership: the join window"
  - id: "one-port-and-tunneled-workers"
    title: "One port, and tunneled workers"
  - id: "activating-the-overlay"
    title: "Activating the overlay"
  - id: "per-case-libtorch-heterogeneous-rigs"
    title: "Per-case libtorch (heterogeneous rigs)"
  - id: "nccl-version-skew"
    title: "NCCL version skew"
  - id: "readiness-gate---fdl-probe"
    title: "Readiness gate - fdl probe"
  - id: "live-run-status---fdl-status"
    title: "Live run status - fdl status"
...
[`fdl join-config`](/guide/0.8.x/cli/cluster#fdl-join-config),
...
See [CLI reference](/guide/0.8.x/cli/cluster#fdl-cluster-cmd---multi-host-fan-out) for the full command surface.
...
See [CLI reference](/guide/0.8.x/cli/cluster#fdl-nccl) for full options.
...
warnings-only. See [CLI reference](/guide/0.8.x/cli/cluster#fdl-probe) for the full
field listing.
...
[CLI reference](/guide/0.8.x/cli/cluster#fdl-status) for address resolution details.
