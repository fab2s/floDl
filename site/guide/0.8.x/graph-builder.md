---
permalink: /guide/0.8.x/graph-builder
channel: 0.8.x
sitemap: true
layout: guide
title: "The Graph Builder"
prev_url: /guide/0.8.x/training
prev_title: "Training"
next_url: /guide/0.8.x/advanced-graphs
next_title: "Advanced Graphs"
anchors:
  - id: "your-first-graph"
    title: "Your first graph"
  - id: "residual-connections-with-also"
    title: "Residual connections with also"
  - id: "parallel-branches-with-splitmerge"
    title: "Parallel branches with split/merge"
  - id: "naming-points-with-tag"
    title: "Naming points with tag"
  - id: "naming-parallel-branches-with-tag_group"
    title: "Naming parallel branches with tag_group"
  - id: "multiple-inputs-with-input"
    title: "Multiple inputs with input"
  - id: "per-element-processing-with-map"
    title: "Per-element processing with map"
  - id: "sub-graphs-as-modules"
    title: "Sub-graphs as modules"
...
> **Prerequisites**: familiarity with [Modules](/guide/0.8.x/modules) and
> [Training](/guide/0.8.x/training). You don't need to have read them - the
> code here is self-contained - but they explain the building blocks.

> **Runnable examples**:
> [`flowbuilder_residual`](https://github.com/flodl-labs/flodl/tree/main/flodl/examples/flowbuilder_residual) is an MLP with a
> tagged residual block; [`quickstart`](https://github.com/flodl-labs/flodl/tree/main/flodl/examples/quickstart) trains one.
...
[Advanced Graphs](/guide/0.8.x/advanced-graphs) for the full story.
...
[graph tree](/guide/0.8.x/graph-tree) features: selective freeze/thaw, subgraph
...
[Advanced Graphs](/guide/0.8.x/advanced-graphs) tutorial covers:
